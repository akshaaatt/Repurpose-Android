...
import com.aemerse.repurpose.util.PreferenceHelper
import com.aemerse.repurpose.util.TinyDB
...
import com.aemerse.repurpose.view.fragment.HomeFragment
...
class ECartHomeActivity : AppCompatActivity() {
    ...
    private val viewModel: com.aemerse.repurpose.domain.PaymentSheetViewModel by lazy {
        com.aemerse.repurpose.domain.PaymentSheetViewModel(application)
    }
